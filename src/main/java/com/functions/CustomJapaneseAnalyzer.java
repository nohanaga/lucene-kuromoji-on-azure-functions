...
import com.functions.cjk.CJKWidthCharFilter;
...
public class CustomJapaneseAnalyzer extends StopwordAnalyzerBase {
  ...
  private static class DefaultSetHolder {
    ...
    static {
      try {
        DEFAULT_STOP_SET =
            loadStopwordSet(true, CustomJapaneseAnalyzer.class, "stopwords.txt", "#"); // ignore case
        final CharArraySet tagset =
            loadStopwordSet(false, CustomJapaneseAnalyzer.class, "stoptags.txt", "#");
  ...
  protected CharArraySet getDefaultStopSet2() {
	    return DefaultSetHolder.DEFAULT_STOP_SET;
	  }
}